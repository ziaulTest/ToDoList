...
namespace ToDoListServiceTests.Scenarios.Data_Validation
{
    ...
    {
        [Test]
        public void Given_A_TodoList_Item_That_Needs_ToBe_Updated_When_A_User_Tries_To_Add_An_invalid_ToDoList_Description_Then_The_Response_is_BadRequest()
        {
            this.Given(_ => _.A_Invalid_Request_To_View_A_ToDoList())
